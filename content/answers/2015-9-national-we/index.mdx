...
2. 수신단에서는 BPF를 이용해서 원하는 신호 대역만 뽑아낸다. 따라서 노이즈도 같이 필터링되는데, 이를 대역통과 노이즈라고 한다.
  대역통과 노이즈를 $n(t)$라고 하자. 이를 ㅁㄴㅇㄻㄴㅇㄻㄴㅇㄻㄴㅇㄹ
  ...
  $$
  이다. 송신 신호 전력은 메시지에 코사인이 곱해진 것이므로 메시지 전력의 절반이 되어 (자세한 증명은 다음 해설의 7번 문제를 참고하시라: [2017 9급 무선공학개론](https://ingyerlog.kr/2017-9-national-we/))
  $$

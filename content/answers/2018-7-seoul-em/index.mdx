...
&=\left(\left.\frac{1}{2}x\right|_0^1 \right)\left( y^3|_0^1\right)\\
&=0.5
\end{split}
\end{equation}
$$
...
\begin{equation}
\begin{split}
\Rightarrow \rho_l&=1.8\times 10^4\frac{10\times 10^{-9}}{18}\cdot 3\\
&=3 \mu
\end{split}
\end{equation}
$$
...
\begin{equation}
\begin{split}
H&=frac{\sqrt{2}}{4\pi \frac{d}{2}}\left(2\cdot \frac{\sqrt{2}}{2}\cot 4\right)\\
&=\frac{4}{\pi d}
\end{split}
\end{equation}
$$
...
$$
I\frac{\pi \left(\frac{r}{2}\right)^2}{\pi r^2}=\frac{I}{4}
$$
